...
plot(roc_curve_svml,print.auc = TRUE ,asp = NA)
...
roc_curve_svmr <- roc(test.df$RESPONSE, svmr_predict_prob[,2], plot = TRUE, print.auc = TRUE, add = TRUE)
#plot(roc_curve_svmr,print.auc = TRUE ,asp = NA,col="red")
